...
function Professions() {
  ...
  const {
    ...
    isPending,
    error,
  } = useGetFetch(`${import.meta.env.VITE_BASE_URL}/kasb-mutaxasisslik/${Id}`);
  ...
  return (
    <div className="w-full">
      ...
      {professions ? (
        ...
        >
          <h1 className='font-bold '>Kasb va mutaxassisliklar <span className='text-primary font-bold rounded ml-2 px-3 py-0.5 bg-base-300'>{professions.length}</span></h1>
