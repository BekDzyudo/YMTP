...
function ShortTermCourseDetail() {

    const { theme } = useGlobalContext();
    const { shortTermCourseId } = useParams();
    const {
    data,
    isPending,
    error,
  } = useGetFetch(
    `${import.meta.env.VITE_BASE_URL}/qisqa-muddatli-kurslar/${shortTermCourseId}`
  );
...
export default ShortTermCourseDetail