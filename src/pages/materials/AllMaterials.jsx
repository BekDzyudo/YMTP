      ...
      {!teacherMaterialList?.materiallar?.length == 0 ? (
        <div className="flex flex-col gap-5">
          <div className="breadcrumbs text-sm md:text-[16px] hidden md:block">
            <ul>
              <li>
                <Link to="/teachers">Fan nomi</Link>
              </li>
            </ul>
          </div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="flex flex-col gap-2 text-sm">
                            <div className="flex items-center justify-between">
                              <span className="text-gray-600">Ko'rilgan:</span>
                              <span className="font-semibold">{material.view_count || 0}</span>
                            </div>
                            <div className="flex items-center justify-between">
                              <span className="text-gray-600">Yuklab olingan:</span>
