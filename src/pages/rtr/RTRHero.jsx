              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 mt-8 sm:mt-10 z-20 max-w-6xl mx-auto w-full sm:px-4">
                {[
                  ...
                  >
                    ...
                    {/* Card */}
                    <div className="relative rounded-3xl p-4 sm:p-5 flex flex-col items-center gap-2 border border-white/20 hover:border-white/35 transition-all duration-300 hover:scale-105 min-h-[160px] justify-center shadow-2xl" style={{ background: "rgba(10,10,30,0.45)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" }}>
